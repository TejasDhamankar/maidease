...
const rateSections: RateSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { service: "12 Hours Maid", charge: "Rs. 25,000" },
      { service: "24 Hours Live-In Maid", charge: "Rs. 40,000" },
    ],
  },
  {
    id: "baby-care",
  ...
  },
  {
    ...
    rows: [
      { service: "Home Nurse", details: "12 Hours", charge: "Rs. 40,000" },
      { service: "24-Hour Nurse", charge: "Rs. 80,000" },
  ...
  },
  {
    ...
    rows: [
      ...
      { service: "Reception Support", charge: "Rs. 30,000" },
